...
class AnalogStickPressEventTest {

    private Controller controller;
    private AnalogStick stick;
    private Direction direction;
    private AnalogStickPressEvent event;
    ...
    void createEvent() {
        ...
        this.event = new AnalogStickPressEvent(controller, stick, direction);
    }
    ...
    void testInit() {
        ...
        assertThrows(NullPointerException.class,
                () -> new AnalogStickPressEvent(controller, stick, null));
    }
