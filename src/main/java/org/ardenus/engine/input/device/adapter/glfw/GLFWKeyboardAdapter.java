...
public class GLFWKeyboardAdapter extends GLFWDeviceAdapter<Keyboard> {
	...
	public static final KeyMapping
			...
			KP_DECIMAL = new GLFWKeyMapping(Keyboard.KP_DECIMAL, GLFW_KEY_KP_DECIMAL),
			KP_DIVIDE = new GLFWKeyMapping(Keyboard.KP_DIVIDE, GLFW_KEY_KP_DIVIDE),
			KP_MULTIPLY = new GLFWKeyMapping(Keyboard.KP_MULTIPLY, GLFW_KEY_KP_MULTIPLY),
			KP_SUBTRACT = new GLFWKeyMapping(Keyboard.KP_SUBTRACT, GLFW_KEY_KP_SUBTRACT),
