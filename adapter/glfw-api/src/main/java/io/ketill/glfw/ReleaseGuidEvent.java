...
/**
 * Emitted by {@link GlfwJoystickSeeker} when a GUID is released.
 */
public final class ReleaseGuidEvent extends GlfwJoystickSeekerEvent {

    private final String guid;
    private final GlfwJoystickWrangler<?> wrangler;

    ReleaseGuidEvent(@NotNull GlfwJoystickSeeker<?> seeker,
                     @NotNull String guid,
